...
<section class="woocommerce-order-downloads tp-woo-cart-table tp-woo-myaccount-order-table is-download-table">
	<?php if ( isset( $show_title ) ) : ?>
		<h2 class="woocommerce-order-downloads__title tp-woo-myaccount-order-view-title"><?php esc_html_e( 'Downloads', 'metisse' ); ?></h2>
	<?php endif; ?>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								...
								case 'download-remaining':
									echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'metisse' );
									break;
