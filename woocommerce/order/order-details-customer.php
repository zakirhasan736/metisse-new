	...
	<div class="row">
			...
			<div class="tp-woo-order-customer-details-item profile__address-item d-sm-flex align-items-start">
				...
				<div class="profile__address-content">
					...
					<div class="profile__address-header d-sm-flex align-items-center ">
						<h3 class="profile__address-title"><?php echo esc_html__('Billing Address', 'metisse'); ?></h3>
					</div>
	
					<?php if(!empty($name)) :?>
					<p><span><?php esc_html_e( 'Name:', 'metisse' ); ?></span><?php echo esc_html($name); ?></p>
					<?php endif; ?>
					
					<!-- street -->
					<?php if ( $email ) : ?>
					<p><span><?php esc_html_e( 'Email:', 'metisse' ); ?></span><?php echo esc_html( $email ); ?></p>
					<?php endif; ?>
					<!-- phone -->
					<?php if ( $phone ) : ?>
					<p><span><?php esc_html_e( 'Phone number:', 'metisse' ); ?></span><?php echo esc_html( $phone ); ?></p>
					<?php endif; ?>
					<!-- street -->
					<?php if ( $company ) : ?>
					<p><span><?php esc_html_e( 'Company:', 'metisse' ); ?></span><?php echo esc_html( $company ); ?></p>
					<?php endif; ?>
					<!-- street -->
					<?php if ($add_1 ) : ?>
					<p><span><?php esc_html_e( 'Address 1:', 'metisse' ); ?></span><?php echo esc_html($add_1 ); ?></p>
					<?php endif; ?>
					<!-- street -->
					<?php if ( $add_2 ) : ?>
					<p><span><?php esc_html_e( 'Address 2:', 'metisse' ); ?></span><?php echo esc_html( $add_2 ); ?></p>
					<?php endif; ?>
					<!-- city -->
					<?php if ( $city ) : ?>
					<p><span><?php esc_html_e( 'City:', 'metisse' ); ?></span><?php echo esc_html( $city ); ?></p>
					<?php endif; ?>
					<!-- state -->
					<?php if ( $state ) : ?>
					<p><span><?php esc_html_e( 'State/province/area:', 'metisse' ); ?></span><?php echo esc_html( $state ); ?></p>
					<?php endif; ?>
					<!-- zip code -->
					<?php if ( $postcode ) : ?>
					<p><span><?php esc_html_e( 'Zip code:', 'metisse' ); ?></span><?php echo esc_html( $postcode ); ?></p>
					<?php endif; ?>
					<!-- country -->
					<?php if ( $country ) : ?>
					<p><span><?php esc_html_e( 'Country:', 'metisse' ); ?></span><?php echo esc_html( $country ); ?></p>
					<?php endif; ?>
				</div>
			</div>
		</div>
		...
		<div class="col-md-6 white-bg">
			<div class="tp-woo-order-customer-details-item profile__address-item d-sm-flex align-items-start">
				...
				<div class="profile__address-content">
					<div class="profile__address-header d-sm-flex align-items-center">
						<h3 class="profile__address-title"><?php echo esc_html__('Shipping Address', 'metisse'); ?></h3>
					</div>
