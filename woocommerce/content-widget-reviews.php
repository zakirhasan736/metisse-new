		...
		<div class="tp-shop-widget-product-content">
			...
			<div class="tp-shop-widget-product-rating-wrapper d-flex align-items-center">
				...
				<div class="tp-shop-widget-product-rating-number">
					<span><?php echo esc_html__('(', 'metisse'); echo esc_html($product->get_average_rating()); echo esc_html__(')', 'metisse'); ?></span>
				</div>
			</div>
			<?php endif; ?>
			...
			<span class="reviewer">
				<span> <?php echo esc_html__( 'by ', 'metisse' ); ?> <span><?php echo get_comment_author( $comment->comment_ID ) ?></span> </span>
			</span>
		</div>
