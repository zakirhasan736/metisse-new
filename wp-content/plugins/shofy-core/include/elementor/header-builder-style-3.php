...
class TP_Header_03 extends Widget_Base {
	...
	protected function render() {
     ...
     elseif ($get_offcanvas_style == "green") {
      ...
      <!-- header area start -->
      <header>
         <div id="header-sticky" class="tp-header-area tp-header-style-transparent-white tp-header-transparent tp-header-sticky has-dark-logo tp-header-height tp-el-section">
