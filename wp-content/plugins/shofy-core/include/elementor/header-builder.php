...
class TP_Header_01 extends Widget_Base {
    ...
    protected function style_tab_content(){
      ...
      $this->tp_icon_style('fact_box_icon', 'Social - Icon', '.tp-el-social-icon span');
                     ...
                     <div class="col-md-6">
                        ...
                        <?php foreach ($settings['tp_header_topbar_contact_list'] as $item) : 
                           ...
                           <div class="tp-header-info-item">
                              <a href="<?php echo esc_url($contact_url ); ?>" class="tp-el-social-icon tp-el-social-title">
                              ...
                              <div class="tp-header-bottom-right-inner d-flex align-items-center justify-content-end pl-30">
                                 ...
                                 <div class="tp-header-search-2 d-none d-sm-block tp-el-search-input">
                                    <form action="<?php print esc_url( home_url( '/shop' ) );?>">
                                       <input type="text"  placeholder="<?php print esc_attr__( 'Search for Products...', 'tpcore' );?>" name="s" value="<?php print esc_attr( get_search_query() )?>">
                                       <button type="submit">
