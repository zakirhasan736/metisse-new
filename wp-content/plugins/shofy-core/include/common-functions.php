...
trait TPCoreElementFunctions
{
    ...
    */
    ...
    protected function tp_columns_2($control_id = 'columns_options', $control_name = 'Select Columns', $control_condition = 'layout-1'){
        $this->start_controls_section(
            'tp_' . $control_id . 'columns_section',
            [
                'label' => esc_html__($control_name, 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Large', 'tpcore' ),
                'description' => esc_html__( 'Screen width between 992px - 1199px', 'tpcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'tpcore' ),
                    2 => esc_html__( '2 Columns', 'tpcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Tablet', 'tpcore' ),
                'description' => esc_html__( 'Screen width between 768px - 991px', 'tpcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'tpcore' ),
                    2 => esc_html__( '2 Columns', 'tpcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'tpcore' ),
                'description' => esc_html__( 'Screen width between 576px - 767px', 'tpcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'tpcore' ),
                    2 => esc_html__( '2 Columns', 'tpcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Small Device', 'tpcore' ),
