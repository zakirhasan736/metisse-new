...
if ( 'yes' == $settings['eael_show_title'] ) {
	$eael_ct_content .= '<' . $settings['title_tag'] . ' class="eael-timeline-title"><a href="' . esc_url( $content['permalink'] ) . '"' . $content['nofollow'] . '' . $content['target_blank'] . '>' . $content['title'] . '</a></' . $settings['title_tag'] . '>';
}
