					...
					<div class="eael-horizontal-timeline-item__card <?php echo esc_attr( $arrow_direction ) ?>">
						<div class="eael-horizontal-timeline-item__card-inner">
							...
							if ( 'yes' == $settings['eael_show_title'] ) {
								$content_html .= '<' . $settings['title_tag'] . ' class="eael-horizontal-timeline-item__card-title"><a href="' . esc_url( $content['permalink'] ) . '"' . $content['nofollow'] . '' . $content['target_blank'] . '>' . $content['title'] . '</a></' . $settings['title_tag'] . '>';
							}
