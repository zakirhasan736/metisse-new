...
class Post_Carousel extends Widget_Base
{
	...
	protected function print_entry_content_style_1( $settings ){
		...
		if ( $settings['eael_show_title'] || $settings['eael_show_meta'] || $settings['eael_show_excerpt'] ):
			...
			if ( $settings['eael_show_title'] ) {
				$html .= '<' . $settings['title_tag'] . ' class="eael-entry-title">';
				$html .= '<a class="eael-grid-post-link" href="' . get_permalink() . '" title="' . get_the_title() . '"' . $settings['title_link_nofollow'] . '' . $settings['title_link_target_blank'] . '>';
	...
	protected function print_entry_content_style_2( $settings ){
		...
		if ( $settings['eael_show_title'] || $settings['eael_show_meta'] || $settings['eael_show_excerpt'] ):
			...
			if ( $settings['eael_show_title'] ) {
				$title = '<' . $settings['title_tag'] . ' class="eael-entry-title">';
				$title .= '<a class="eael-grid-post-link" href="' . get_permalink() . '" title="' . get_the_title() . '"' . $settings['title_link_nofollow'] . '' . $settings['title_link_target_blank'] . '>';
				if ( empty( $settings['eael_title_length'] ) ) {
					$title .= get_the_title();
				} else {
