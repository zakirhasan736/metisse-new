...
trait Woo_Product_Comparable {
	...
	public static function get_field_types() {
		return apply_filters( 'eael/wcpc/default-fields', [
			...
			'add-to-cart' => __('Shop now', 'essential-addons-for-elementor-lite' ),
	...
	public static function get_default_rf_fields() {
		return apply_filters( 'eael/wcpc/default-rf-fields', [
			...
			[
				...
				'field_label' => __('Shop now', 'essential-addons-for-elementor-lite' ),
			],
			[
				'field_type'  => 'sku',
	...
	public function init_content_table_settings_controls() {
		...
		$this->add_control( 'repeat_add_to_cart', [
			'label'       => __('Repeat "Shop now" field', 'essential-addons-for-elementor-lite' ),
			'description' => __('Repeat the "Shop now" field at the end of the table', 'essential-addons-for-elementor-lite' ),
			'type'        => Controls_Manager::SWITCHER,
		] );
