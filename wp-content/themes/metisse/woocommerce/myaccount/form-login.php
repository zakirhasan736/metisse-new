						...
						<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
							...
							<?php if ('no' === get_option('woocommerce_registration_generate_username')) : ?>
								...
								<!-- <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-[30px] sm:mb-[15px]">
									...
									<input placeholder="Username" type="text" class="woocommerce-Input woocommerce-Input--text input-text text-[12px] sm:text-[11px] text-[#7B7C79] font-semibold font-primary leading-[1.5] !py-[16px] !px-[20px] placeholder:opacity-50 !border-b-2 !border-b-[#7B7C79]" name="username" id="reg_username" autocomplete="username" value="<?php echo (!empty($_POST['username'])) ? esc_attr(wp_unslash($_POST['username'])) : ''; ?>" />
								</p> -->
							...
							<div class="user-email-pass-box">
								<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-[30px] sm:mb-[15px]">
									...
									<input placeholder="johndoe@domain.com" type="email" class="woocommerce-Input woocommerce-Input--text input-text text-[12px] sm:text-[11px] text-[#7B7C79] font-semibold font-primary leading-[1.5] !py-[16px] !px-[20px] placeholder:opacity-50 !border-b-2 !border-b-[#7B7C79]" name="email" id="reg_email" autocomplete="email" value="<?php echo (!empty($_POST['email'])) ? esc_attr(wp_unslash($_POST['email'])) : ''; ?>" />
								</p>
								...
								<?php if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
									...
									<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide mb-[30px] sm:mb-[15px]">
										...
										<input placeholder="Password" type="password" class="woocommerce-Input woocommerce-Input--text input-text text-[12px] sm:text-[11px] text-[#7B7C79] font-semibold font-primary leading-[1.5] !py-[16px] !px-[20px] placeholder:opacity-50 !border-b-2 !border-b-[#7B7C79]" name="password" id="reg_password" autocomplete="new-password" />
									</p>
					...
					<form class="woocommerce-form woocommerce-form-login login" method="post">
						...
						<div class="user-email-pass-box">
							<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row-first mb-[30px] sm:mb-[15px]">
								...
								<input type="text" class="woocommerce-Input woocommerce-Input--text input-text text-[12px] sm:text-[11px] text-[#7B7C79] font-semibold font-primary leading-[1.5] !py-[16px] !px-[20px] placeholder:opacity-50 !border-b-2 !border-b-[#7B7C79]" placeholder="johndoe@domain.com" name="username" id="username" autocomplete="username" value="<?php echo (!empty($_POST['username'])) ? esc_attr(wp_unslash($_POST['username'])) : ''; ?>" />
							</p>
							<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row-last">
								...
								<input class="woocommerce-Input woocommerce-Input--text input-text text-[12px] sm:text-[11px] text-[#7B7C79] font-semibold font-primary leading-[1.5] !py-[16px] !px-[20px] placeholder:opacity-50 !border-b-2 !border-b-[#7B7C79]" placeholder="••••••••••" type="password" name="password" id="password" autocomplete="current-password" />
							</p>
						</div>
