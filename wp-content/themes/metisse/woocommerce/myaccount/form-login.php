				...
				<div class="h-full login-area-fomr-box pt-[145px] max-w-[460px] w-full mr-auto">
					...
					<form class="woocommerce-form woocommerce-form-login login" method="post">
						...
						<div class="auth-submit flex items-start flex-col md:gap-[15px]">
							<button type="submit" class="woocommerce-button button woocommerce-form-login__submit !text-[11px] !text-[#FFFDFD] !h-[40px] !font-primary !font-normaL !bg-[#131313] !uppercase !py-2 px-8 !leading-[1.1] w-full<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="login" value="<?php esc_attr_e('Login', 'metisse'); ?>"><?php esc_html_e('Login', 'metisse'); ?></button>
