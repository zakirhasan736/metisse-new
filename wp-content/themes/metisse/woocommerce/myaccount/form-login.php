	...
	<div class="grid grid-cols-12 sm:grid-cols-6 h-full" id="customer_login">
		...
		<?php if ('yes' === $woocommerce_enable_myaccount_registration) : ?>
			<div class="col-span-6 sm:col-span-6 h-full">
				<div class="tp-woo-input-field !mt-0 h-full pl-20 md:px-10 pr-[120px]  tp-woo-form-login tp-woo-myaccount-register registaretion-forms">
		...
		<div class="col-span-6 sm:col-span-6 h-full">
			<div class="tp-woo-input-field  px-20 md:px-10 !mt-0 h-full tp-woo-form-login login-forms">
