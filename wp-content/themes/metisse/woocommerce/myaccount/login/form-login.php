...
<div class="row <?php echo esc_attr($form_row); ?>" id="customer_login">
	...
	<div class="<?php echo esc_attr($form_col); ?>">
		<div class="tp-woo-input-field tp-woo-form-login">
			<h2 class="tp-woo-myaccount-login-title"><?php esc_html_e( 'Login', 'metisse' ); ?></h2>
			...
			<form class="woocommerce-form woocommerce-form-login login" method="post">
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row-first ">
					<label for="username"><?php esc_html_e( 'Username or email address', 'metisse' ); ?>&nbsp;<span class="required">*</span></label>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row-last">
					<label for="password"><?php esc_html_e( 'Password', 'metisse' ); ?>&nbsp;<span class="required">*</span></label>
				...
				<p class="form-row">
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
						<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'metisse' ); ?></span>
					</label>
					<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
					<button type="submit" class="woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Log in', 'metisse' ); ?>"><?php esc_html_e( 'Log in', 'metisse' ); ?></button>
				</p>
				<p class="woocommerce-LostPassword lost_password">
					<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'metisse' ); ?></a>
				</p>
	...
	<div class="col-lg-6">
		<div class="tp-woo-input-field tp-woo-form-login tp-woo-myaccount-register">
			<h2 class="tp-woo-myaccount-login-title"><?php esc_html_e( 'Register', 'metisse' ); ?></h2>
