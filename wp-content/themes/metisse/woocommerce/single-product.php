...
<section class="product-feature-type-featured-product overflow-hidden pt-[76px] sm:pt-[60px] pb-[50px]">
								...
								<div class="product--card-main-cont flex items-start gap-[20px]">
									...
									<div class="product--card-cont pt-5 pb-[22px]">
										...
										<div class="product--features-watches-btn-box text-left relative left-0 w-full h-full flex flex-col items-start justify-start">
											<p class="product-price text-[20px] text-left font-secondary font-normal capitalize text-black mb-[14px]"><?php echo get_woocommerce_currency_symbol() . get_post_meta(get_the_ID(), '_price', true); ?></p>
