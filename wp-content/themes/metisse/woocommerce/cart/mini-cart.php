					...
					<?php
						echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							...
							sprintf(
								...
								esc_attr__( 'Remove this item', 'metisse' ),
								esc_attr( $product_id ),
...
<?php else : ?>
	...
	<div class="cartmini__empty text-center">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/cartmini/empty-cart.png" alt="<?php echo esc_attr__('empty-cart', 'metisse'); ?>">
		<p><?php esc_html_e( 'Your Cart is empty', 'metisse' );?></p>
		<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="tp-btn"><?php esc_html_e( 'Go To Shop', 'metisse' );?></a>
	</div>
