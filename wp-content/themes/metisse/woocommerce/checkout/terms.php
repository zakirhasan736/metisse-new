	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<?php if (wc_terms_and_conditions_checkbox_enabled()) : ?>
			<p class="form-row validate-required">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox text-[14px] sm:text-[12px] font-medium font-primary leading-[25px] text-[#000]">
