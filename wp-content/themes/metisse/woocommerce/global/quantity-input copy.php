...
?>
	<div class="tp-product-details-quantity !m-0">
		<div class="quantity tp-product-quantity">
			<?php do_action('woocommerce_before_quantity_input_field'); ?>
			<label class="screen-reader-text" for="<?php echo esc_attr($input_id); ?>"><?php echo esc_attr($label); ?></label>
			<div class="quantity-box-wrap !flex !items-center !gap-[5px]">
				<input type="text" class="max-w-[90px] w-full !h-[40px] !p-4 text-center !text-[12px] text-[#131313]  font-secondary !font-normal  !border !border-[#131313]" id="<?php echo esc_attr($input_id); ?>" class="<?php echo esc_attr(join(' tp-cart-input ', (array) $classes)); ?>" step="<?php echo esc_attr($step); ?>" min="<?php echo esc_attr($min_value); ?>" max="<?php echo esc_attr(0 < $max_value ? $max_value : ''); ?>" name="<?php echo esc_attr($input_name); ?>" value="<?php echo esc_attr($input_value); ?>" title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'metisse'); ?>" size="4" placeholder="<?php echo esc_attr($placeholder); ?>" inputmode="<?php echo esc_attr($inputmode); ?>" autocomplete="<?php echo esc_attr(isset($autocomplete) ? $autocomplete : 'on'); ?>" />
				<div class="quantity-btn-box !flex !flex-col gap-[5px]">
					<span class="qty_button plus w-[16px] h-[16px] flex !border !border-[#000000] items-center justify-center p-[3px]">
					...
					<span class="qty_button minus w-[16px] h-[16px] flex !border !border-[#000000] items-center justify-center p-[3px]">
