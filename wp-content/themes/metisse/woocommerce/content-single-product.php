							...
							<div class="group-product-offer-price col-span-5  sm:col-span-6 flex items-center justify-center w-full">
								<div class="group-product-price-box-action-btn-box w-full">
									...
									<div class="product-card-checkout-btns text-center relative top-0 left-0 w-full h-full flex flex-col items-center justify-center">
										...
										// Output "Add to Cart" button with the total price
										echo '<button class="add-to-cart-btn max-w-[208px] mx-auto flex items-center justify-center w-full whitespace-nowrap h-[45px] py-[14px] px-[20px] border-2 border-[#000000F2] capitalize text-black text-[14px] font-medium text-center mb-[5px] font-primary leading-[1.2] bg-white" data-total-price="' . $total_price . '">' . esc_html__('Add To Cart', 'metisse') . '</button>';
										?>
