...
<?php the_content(); ?>
<section class="product-feature-type-featured-product overflow-hidden pt-[76px] sm:pt-[60px] pb-[97px] lg:pb-[90px] md:pb-[80px] sm:pb-[60px]">
    <div class="custom-container-site-width flex a">
