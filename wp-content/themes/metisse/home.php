                                ...
                                <div class="product--card-main-cont flex items-start gap-[20px]">
                                    ...
                                    <div class="product--card-cont">
                                        ...
                                        <div class="product--features-watches-btn-box text-left relative left-0 w-full h-full flex flex-col items-start justify-start">
                                            ...
                                            <button class="add-to-cart-btn mx-auto flex items-center justify-center w-full whitespace-nowrap h-[45px] py-2 px-[0px] border-0 capitalize text-[#BD7048] text-[12px] font-semibold text-center font-secondary leading-[1.2]"> <?php woocommerce_template_loop_add_to_cart('Shop now', 'metisse'); ?></button>
                                        </div>
                                    </div>
