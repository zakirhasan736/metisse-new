...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'shofy' ) ) );
	return;
}
			...
			<div class="col-lg-5">
				<div class="tp-woo-checkout-order-details white-bg cart-wrapper mb-30">
					<div class="order-review-wrapper">
						...
						<h3 id="order_review_heading"><?php esc_html_e( 'Your order', 'shofy' ); ?></h3>
