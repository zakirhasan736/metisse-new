...
if ( ! wc_ship_to_billing_address_only() && wc_shipping_enabled() ) {
	$get_addresses = apply_filters(
		...
		array(
			'billing'  => __( 'Billing address', 'shofy' ),
			'shipping' => __( 'Shipping address', 'shofy' ),
		),
		$customer_id
	);
} else {
...
<p class="tp-woo-myaccount-address-msg woocommerce-message">
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'shofy' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</p>
...
<div class="row">
		...
		<div class="profile__address-item d-sm-flex align-items-start">
			...
			<div class="profile__address-content">
				...
				<div class="profile__address-header d-sm-flex align-items-center ">
					<h3 class="profile__address-title"><?php echo esc_html__('Billing Address', 'shofy'); ?></h3>
					<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'billing' ) ); ?>" class="edit"><?php echo array_key_exists('billing', $get_addresses) ? esc_html__( 'Edit', 'shofy' ) : esc_html__( 'Add', 'shofy' ); ?></a>
				</div>

				<?php if(!empty($billing_address)) : ?>
				<?php if(!empty($name)) :?>
				<p><span><?php esc_html_e( 'Name:', 'shofy' ); ?></span><?php echo esc_html($name); ?></p>
				<?php endif; ?>
				
				<!-- street -->
				<?php if ( $email ) : ?>
				<p><span><?php esc_html_e( 'Email:', 'shofy' ); ?></span><?php echo esc_html( $email ); ?></p>
				<?php endif; ?>
				<!-- phone -->
				<?php if ( $phone ) : ?>
				<p><span><?php esc_html_e( 'Phone number:', 'shofy' ); ?></span><?php echo esc_html( $phone ); ?></p>
				<?php endif; ?>
				<!-- street -->
				<?php if ( $company ) : ?>
				<p><span><?php esc_html_e( 'Company:', 'shofy' ); ?></span><?php echo esc_html( $company ); ?></p>
				<?php endif; ?>
				<!-- street -->
				<?php if ($add_1 ) : ?>
				<p><span><?php esc_html_e( 'Address 1:', 'shofy' ); ?></span><?php echo esc_html($add_1 ); ?></p>
				<?php endif; ?>
				<!-- street -->
				<?php if ( $add_2 ) : ?>
				<p><span><?php esc_html_e( 'Address 2:', 'shofy' ); ?></span><?php echo esc_html( $add_2 ); ?></p>
				<?php endif; ?>
				<!-- city -->
				<?php if ( $city ) : ?>
				<p><span><?php esc_html_e( 'City:', 'shofy' ); ?></span><?php echo esc_html( $city ); ?></p>
				<?php endif; ?>
				<!-- state -->
				<?php if ( $state ) : ?>
				<p><span><?php esc_html_e( 'State/province/area:', 'shofy' ); ?></span><?php echo esc_html( $state ); ?></p>
				<?php endif; ?>
				<!-- zip code -->
				<?php if ( $postcode ) : ?>
				<p><span><?php esc_html_e( 'Zip code:', 'shofy' ); ?></span><?php echo esc_html( $postcode ); ?></p>
				<?php endif; ?>
				<!-- country -->
				<?php if ( $country ) : ?>
				<p><span><?php esc_html_e( 'Country:', 'shofy' ); ?></span><?php echo esc_html( $country ); ?></p>
				<?php endif; ?>
				<?php endif; ?>
			</div>
		</div>
	...
	<div class="col-md-6">
		<div class="profile__address-item d-sm-flex align-items-start">
			...
			<div class="profile__address-content">
				<div class="profile__address-header d-sm-flex align-items-center">
					<h3 class="profile__address-title"><?php echo esc_html__('Shipping Address', 'shofy'); ?></h3>
					<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'shipping' ) ); ?>" class="edit"><?php echo array_key_exists('shipping', $get_addresses) ? esc_html__( 'Edit', 'shofy' ) : esc_html__( 'Add', 'shofy' ); ?></a>
				</div>
