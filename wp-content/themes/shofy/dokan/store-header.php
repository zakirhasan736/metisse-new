...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'shofy' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'shofy' );
...
?>
<div class="dokan-profile-frame-wrapper p-relative z-index-11">
                                    ...
                                    <div class="store-open-close-notice">
                                        ...
                                        dokan_get_template_part(
                                            ...
                                            [
                                                ...
                                                'times_heading' => __( 'Weekly Store Timing', 'shofy' ),
                                                'closed_status' => __( 'CLOSED', 'shofy' ),
                                            ]
                                        );
                                        ?>
                                    </div>
