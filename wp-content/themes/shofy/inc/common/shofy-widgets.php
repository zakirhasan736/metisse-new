...
function shofy_widgets_init() {
     ...
     */
    register_sidebar( [
        'name'          => esc_html__( 'Blog Sidebar', 'shofy' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Set Your Blog Widget', 'shofy' ),
     ...
     */
    register_sidebar( [
        'name'          => esc_html__( 'Product Sidebar', 'shofy' ),
        'id'            => 'product-sidebar',
        'description'          => esc_html__( 'Set Your Product Widget', 'shofy' ),
    ...
    for ( $num = 1; $num <= $footer_widgets; $num++ ) {
        register_sidebar( [
            'name'          => sprintf( esc_html__( 'Footer %1$s', 'shofy' ), $num ),
            'id'            => 'footer-' . $num,
            'description'   => sprintf( esc_html__( 'Footer column %1$s', 'shofy' ), $num ),
    ...
    if ( $footer_style_2_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            ...
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 2 : %1$s', 'shofy' ), $num ),
                'id'            => 'footer-2-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 2 : %1$s', 'shofy' ), $num ),
    ...
    if ( $footer_style_3_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 3 : %1$s', 'shofy' ), $num ),
                'id'            => 'footer-3-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 3 : %1$s', 'shofy' ), $num ),
    ...
    if ( $footer_style_4_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 4 : %1$s', 'shofy' ), $num ),
                'id'            => 'footer-4-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 4 : %1$s', 'shofy' ), $num ),
    ...
    if ( $footer_style_5_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 5 : %1$s', 'shofy' ), $num ),
                'id'            => 'footer-5-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 5 : %1$s', 'shofy' ), $num ),
    ...
    if ( $footer_style_6_switch ) {
        for ( $num = 1; $num <= $footer_widgets; $num++ ) {
            register_sidebar( [
                'name'          => sprintf( esc_html__( 'Footer Style 6 : %1$s', 'shofy' ), $num ),
                'id'            => 'footer-6-' . $num,
                'description'   => sprintf( esc_html__( 'Footer Style 6 : %1$s', 'shofy' ), $num ),
                'before_widget' => '<div id="%1$s" class="tp-footer-widget mb-50 footer-col-'.$num.' %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h4 class="tp-footer-widget-title">',
                'after_title'   => '</h4>',
...
add_action( 'widgets_init', 'shofy_widgets_init' );