...
function shofy_breadcrumb_func() {
    global $post;  
    $breadcrumb_class = '';
    $breadcrumb_show = 1;
    ...
    elseif ( is_single() && 'courses' == get_post_type() ) {
      $title = esc_html__( 'Course Details', 'shofy' );
    } 
    elseif ( is_search() ) {
    ...
    $is_breadcrumb = function_exists('tpmeta_field')? tpmeta_field('shofy_check_bredcrumb', $_id) : 'on';
    ...
    $breadcrumb_from_customizer = get_theme_mod('breadcrumb_switch', true);
      ...
      if (  $con1 && $breadcrumb_from_customizer) {
            $bg_img_from_page = function_exists('tpmeta_image_field')? tpmeta_image_field('shofy_breadcrumb_bg') : '';
            $hide_bg_img = function_exists('tpmeta_image_field')? tpmeta_image_field('shofy_check_bredcrumb_img') : 'on';
               ...
               <div class="row">
                  <div class="col-xxl-12">
                        <div class="breadcrumb__content text-center p-relative z-index-1">
                            <h3 class="breadcrumb__title"><?php echo shofy_kses( $title ); ?></h3>
...
add_action( 'shofy_before_main_content', 'shofy_breadcrumb_func' );

// shofy_search_form
function shofy_search_form() { ?>
                ...
                <div class="tp-search-form">
                    ...
                    <form action="<?php print esc_url( home_url( '/shop' ) );?>">
                        <div class="tp-search-input mb-10">
                            <input class="search-input-field" type="text" placeholder="<?php print esc_attr__( 'Search for product...', 'shofy' );?>" name="s" value="<?php print esc_attr( get_search_query() )?>">
                        ...
                        <div class="tp-search-category">
                            ...
                            <span><?php echo esc_html__('Search by :', 'shofy'); ?> </span>
...
add_action( 'shofy_before_main_content', 'shofy_search_form' );
