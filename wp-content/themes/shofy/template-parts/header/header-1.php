<?php 
   ...
   $shofy_menu_col           = $header_right_switch ? 'col-xl-5 d-none d-xl-block' : 'col-xl-10 col-lg-7 col-md-7 col-sm-8 col-6 d-none d-xl-block';
   $shofy_menu_align           = $header_right_switch ? '' : 'justify-content-end';
                  ...
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="tp-header-info d-flex align-items-center">
                           <?php if(!empty($shofy_fb_link)) : ?>
                           <div class="tp-header-info-item">
                              <a href="<?php echo esc_url($shofy_fb_link); ?>">
                                 <span>
                                 ...
                                 </span> <?php echo esc_html($shofy_fb_text); ?>
                              </a>
                           </div>
                           <?php endif; ?>

                           <?php if(!empty($shofy_tel_link)) : ?>
                           <div class="tp-header-info-item">
                              <a href="tel:<?php echo esc_url($shofy_tel_link); ?>">
                                 <span>
                                 ...
                                 </span> <?php echo esc_html($shofy_tel_text); ?>
                              </a>
                           </div>
                           <?php endif; ?>
                        </div>
                     ...
                     <div class="col-md-6">
                        <div class="tp-header-top-right tp-header-top-black d-flex align-items-center justify-content-end">
                           ...
                           <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                              ...
                              <?php if($shofy_header_lang): ?>
                              <?php shofy_header_lang_defualt(); ?>
                              <?php endif; ?>

                              <?php if($shofy_header_currency) : ?>
                              ...
                              <?php if(class_exists( 'WooCommerce' ) && $shofy_header_account) : ?>
                              <div class="tp-header-top-menu-item tp-header-setting">
                                 ...
                                 <ul>
                                    ...
                                    <?php 
                                       if(class_exists( 'WPCleverWoosw' ) && $shofy_header_wishlist) : 
               ...
               <div class="container">
                  <div class="tp-mega-menu-wrapper p-relative">
                     <div class="row align-items-center">
                        ...
                        <div class="<?php echo esc_attr($shofy_menu_col); ?>">
                           <div class="main-menu menu-style-2 d-flex align-items-center <?php echo esc_attr($shofy_menu_align); ?>">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-8 col-6 d-xl-none">
                           <div class="tp-header-action-item tp-header-hamburger mr-20  d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6">
                           <div class="tp-header-bottom-right d-flex align-items-center justify-content-end">
                              ...
                              <div class="tp-header-bottom-right-inner d-flex align-items-center justify-content-end pl-30">
                                 ...
                                 <?php if ( ($shofy_header_compare || $shofy_header_wishlist || $shofy_header_cart) && class_exists( 'WooCommerce' )): ?>
                                 
                                    <div class="tp-header-action d-flex align-items-center ml-30">
   
                                    <?php if(class_exists( 'WPCleverWoosc' ) && $shofy_header_compare) : 
