<?php
    ...
    $author_info = get_the_author_meta( 'metisse_write_by');
    $facebook_url = get_the_author_meta( 'metisse_facebook' );
    $twitter_url = get_the_author_meta( 'metisse_twitter' );
    $linkedin_url = get_the_author_meta( 'metisse_linkedin' );
    $instagram_url = get_the_author_meta( 'metisse_instagram' );
    $youtube_url = get_the_author_meta( 'metisse_youtube' );
    $metisse_write_by = get_the_author_meta( 'metisse_write_by' );
...
?>
    ...
    <div class="tp-postbox-details-author d-sm-flex align-items-start" data-bg-color="#F4F7F9">
        ...
        <div class="tp-postbox-details-author-content">
            <span><?php echo esc_html__( 'Written by', 'metisse' ); ?></span>
